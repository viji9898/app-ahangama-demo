...
const VENUES = {
  livingRoom: {
    ...
    directionsUrl: "https://www.google.com/maps/search/?api=1&query=Living%20Room%20Concept%20Store%20Ahangama",
  },
  kaffi: {
    id: "kaffi",
    name: "Kaffi",
    ...
    storyPath: "/eat",
    directionsUrl: "https://www.google.com/maps/search/?api=1&query=Kaffi%20Ahangama",
  },
  kabalanaBeach: {
    id: "kabalana-beach",
    name: "Kabalana Beach",
    ...
    storyPath: "/guide",
    directionsUrl: "https://www.google.com/maps/search/?api=1&query=Kabalana%20Beach",
  },
  theRock: {
    id: "the-rock",
    name: "The Rock",
    ...
    storyPath: "/guide",
    directionsUrl: "https://www.google.com/maps/search/?api=1&query=The%20Rock%20Ahangama",
  },
  hakunaMatata: {
    id: "hakuna-matata",
    name: "Hakuna Matata",
    ...
    storyPath: "/eat",
    directionsUrl: "https://www.google.com/maps/search/?api=1&query=Hakuna%20Matata%20Ahangama",
  },
  puraPilates: {
    id: "pura-pilates",
    name: "Pura Pilates",
    offer: "A focused movement stop for travellers building wellness into the stay.",
    path: "/wellness",
  },
  frostys: {
    id: "frostys",
...
function getSiteUrl() {
  return String(
    process.env.URL || process.env.DEPLOY_PRIME_URL || DEFAULT_SITE_URL,
  ).replace(/\/$/, "");
}
...
export function generateGuestWelcomeEmail({ guest, pass, preferences } = {}) {
  ...
  const text = [
    ...
    "",
    "Editor's Picks",
    ...venues.map((venue) => `${venue.category}: ${venue.name} - ${venue.description}`),
    "",
