...
const DEPLOYED_EVENT_ASSETS = {
  cafeCeylonMovieNight:
    "https://ahangama.com/assets/Cafe%20Ceylon%20Movie%20Night%20-B13q8rHH.jpeg",
  monoDjNight:
    "https://ahangama.com/assets/Mono%20-%20DJ%20Night%20-Og8tr3Lt.jpg",
  hotelDeUnclesMonsoonNights:
    "https://ahangama.com/assets/Hotel%20De%20Uncles%20Monsoon%20Nights%20-Cm6rpoJM.jpeg",
  sambaHappyHour:
    "https://ahangama.com/assets/Samba%20Haappy%20Hour%20-Bji6FvzF.png",
};
...
const WELCOME_EVENT_SOURCE = [
  {
    ...
    image: eventImagePath("Surf Club midigama - Sunset Club Event Flyer.jpg"),
    instagramUrl:
  ...
  },
  {
    ...
    venue: "Cafe Ceylon",
    time: "6:15 PM",
    image: DEPLOYED_EVENT_ASSETS.cafeCeylonMovieNight,
    instagramUrl:
      "https://www.instagram.com/cafe_ceylon?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
    directionsUrl:
      "https://www.google.com/maps/search/?api=1&query=Cafe%20Ceylon%20Ahangama",
  },
  {
    dateKey: "2026-07-03",
    ...
    image: DEPLOYED_EVENT_ASSETS.monoDjNight,
    instagramUrl:
      "https://www.instagram.com/find_mono_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
    directionsUrl:
      "https://www.google.com/maps/search/?api=1&query=Mono%20Ahangama",
  },
  {
    dateKey: "2026-07-04",
    ...
    time: "6:00 PM",
    image: DEPLOYED_EVENT_ASSETS.hotelDeUnclesMonsoonNights,
    instagramUrl:
  ...
  },
  {
    ...
    image: DEPLOYED_EVENT_ASSETS.sambaHappyHour,
    instagramUrl:
...
function getWelcomeEvents(date = new Date()) {
  ...
  const datedEvents = WELCOME_EVENT_SOURCE.filter(
    (event) => event.dateKey !== "ongoing" && event.dateKey >= todayKey,
  );
  const ongoingEvents = WELCOME_EVENT_SOURCE.filter(
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td style="padding:18px 0 18px;border-bottom:1px solid #242424;vertical-align:top;">
              <div style="font-family:Georgia,'Times New Roman',serif;font-size:26px;line-height:.98;font-weight:700;color:#242424;margin:0;">${escapeHtml(item.vendor)}</div>
              <div style="font-family:Georgia,'Times New Roman',serif;font-size:16px;line-height:1.18;font-weight:600;font-style:italic;color:#242424;margin:8px 0 0;">${escapeHtml(item.tagline)}</div>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#fff;">
              ...
              <tr>
                <td style="padding:16px 20px 0;">
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:12px;">${NEWSLETTER_DATA.map(
                    (item, index) => buildVendorHtml(guest, pass, item, index),
                  ).join("")}</table>
                </td>
              </tr>
              <tr>
