...
const LOCAL_PICKS_INSERT_AFTER_INDEX = 4;
...
export function generateGuestWelcomeEmail({ guest, pass } = {}) {
  ...
  const text = [
    ...
    ...NEWSLETTER_DATA.flatMap((item, index) => {
      ...
      return [pickLine, `Article: ${FEATURED_ARTICLES[0].title}`];
    }),
    "",
    "WORTH READING",
