...
export function generateGuestWelcomeEmail({ guest, pass } = {}) {
  ...
  const isHospoWelcomeEmail = pass?.sourceHotelSlug === "ahangama-hospo";
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#fff;">
              <tr>
                <td style="padding:24px 20px 24px;background:#fff;border-top:2px solid #111;border-bottom:2px solid #111;color:#111;">
                  ${isHospoWelcomeEmail ? "" : `<div style="font-family:Arial,sans-serif;font-size:9px;line-height:1.2;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:${ACCENT};margin:0 0 10px;">Lighthouse Guest Pass</div>`}
