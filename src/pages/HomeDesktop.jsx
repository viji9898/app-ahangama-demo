    ...
    return (
      <>
        ...
        >
          ...
          >
            Explore exclusive venues, perks, and experiences with your Ahangama Pass. Find your next favorite spot below!
          </p>
        </div>
        ...
        >
          ...
          />
          <div style={{ display: "flex", gap: 7, marginBottom: 0, flexWrap: "wrap", background: "#F6EFE8", justifyContent: "center" }}>
            <button
            ...
            {CATEGORIES.map((cat) => (
              <button
                ...
                style={{
                  ...
                  padding: "6px 12px",
                  borderRadius: 6,
                  border: category === cat.key ? "2px solid #bfa16a" : "1px solid #eee",
                ...
                >
                  ...
                  <div style={{ display: "flex", width: "100%", marginTop: 8 }}>
                    <button
                      ...
                      onClick={() =>
                        place.mapUrl && window.open(place.mapUrl, "_blank", "noopener,noreferrer")
                      }
      ...
      >
        &copy; {new Date().getFullYear()} Ahangama Pass. Made with <span style={{color: '#bfa16a'}}>♥</span> in Sri Lanka.
      </footer>
    </>
  );
}
