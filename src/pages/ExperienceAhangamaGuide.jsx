...
const BEST_STAYS = [
  ...
  { name: "Sisters Cafe", rating: "4.6", desc: "A warm, family-run cafe serving fresh breakfasts, homemade cakes and great coffee by the road.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287236/sisters_cafe_pumrbp.png", lat: 5.9779099, lng: 80.3513977, instagram: "", googleMaps: "", ownership: "local" }, 
...
const BEST_CAFES = [
  ...
  { name: "Black Honey", rating: "4.7", desc: "A hidden gem serving rich single-origin brews, honey-infused treats and laid-back coastal charm.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787500795/Black_Honey_new_gi0q8a.webp", lat: 5.978427591667606, lng: 80.34855730859866, instagram: "", googleMaps: "", ownership: "local" },
  ...
  { name: "Living Room", rating: "4.6", desc: "A trendy co-working cafe with great coffee, healthy meals and a creative social atmosphere.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787593886/livingroom_uh4nno_copy_sa1icq.webp", lat: 5.972781176617157, lng: 80.36349925767135, instagram: "", googleMaps: "", ownership: "foreign" },
