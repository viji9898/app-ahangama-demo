...
const BEST_STAYS = [
  ...
  { name: "Villa Alba", rating: "4.8", desc: "", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1788232974/Alba_ptcx0i.webp", instagram: "https://www.instagram.com/villaalba_srilanka/?hl=en", googleMaps: "https://maps.app.goo.gl/pymFpU8Agpkte4E3A", ownership: "foreign" },
...
const EATS = [
  ...
  { name: "RIBS", rating: "4.8", desc:"Smokin’ Hot", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1788173203/RIBS_A_k56cyw.webp", instagram: "https://www.instagram.com/ribs.ahangama/?hl=en", googleMaps: "https://maps.app.goo.gl/A7cjomUMU4UGxT8H6", ownership: "local" },
...
const EXPERIENCES = [
  ...
  { name: "Swing Ceylon", rating: "4.6", desc: "Sri Lanka’s premier 18-hole jungle mini golf course, complete with lawn games, a treehouse deck, and a tropical cocktail bar.", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1788156822/Swing_Ceylone_vgrmrp.webp", instagram: "https://www.instagram.com/swing.ceylon/?hl=en", googleMaps: "https://maps.app.goo.gl/waWiDjHZGnV3YJ4w5"},
  ...
  { name: "Global Surf Lodge", rating: "4.4", desc: "A high-end surf and wellness retreat in Sri Lanka offering progression-focused coaching, daily yoga, and an intimate boutique atmosphere steps from Kabalana Beach.", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1788166245/globalsurf_eifspc.webp", instagram: "https://www.instagram.com/globalsurf_kabalana/?hl=en", googleMaps: "https://maps.app.goo.gl/2bUseoXQ3eYPbd5Y7"}
];
...
const BEST_RETAIL_STORES = [
  ...
  { name: "Tea Zone Ceylon", rating: "4.8", desc:"A curated coastal boutique offering an immersive tasting experience of premium Ceylon teas and artisanal spices.", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1788155916/teazoneceylon_goyb6b.webp", lat: 5.9719583, lng: 80.3644725, instagram: "https://www.instagram.com/teazoneceylon/?hl=en", googleMaps: "https://maps.app.goo.gl/w66kkDZuxQU8nxmt9", ownership: "foreign" },
  { name: "Saloon Change", rating: "4.4", desc:"Your go-to hub in Ahangama for expert hair styling, premium keratin treatments, and professional bridal makeovers.", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1788157751/Saloon_Change_qkoqnk.webp", instagram: "https://www.instagram.com/salon_change/?hl=en", googleMaps: "https://maps.app.goo.gl/LBXMUNvjKwSDuezK6", ownership: "foreign" },
];
...
const BEST_CAFES = [
  ...
  { name: "Sisters Cafe", rating: "4.6", desc: "Mediterranean flavours with an island twist, exceptional coffee, proudly brought to life by our team of local women.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1788160987/Sisters_Cafe_hunfx4.webp", lat: 5.9779099, lng: 80.3513977, instagram: "https://www.instagram.com/sisterssrilanka/?hl=en", googleMaps: "https://maps.app.goo.gl/Wd8wyGMaVWvMpE478", ownership: "local" },
  ...
  { name: "Thileni's", rating: "4.8", desc: "A vibrant beachfront cafe and sunset lounge in Ahangama offering front-row surf views, creative coastal fusion cuisine, and an upscale, barefoot-luxury vibe.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1788154644/Thileni_s_mz5rq1.webp", lat: 5.9782004, lng: 80.348526, instagram: "https://www.instagram.com/thilenis_ahangama/?hl=en", googleMaps: "https://maps.app.goo.gl/6v8ZtnzJvpLWvZsc8", ownership: "local" },  
  { name: "Cafe Ceylon", rating: "4.5", desc: "A rustic cafe blending Ceylon tea traditions with modern cafe culture in a relaxed setting.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287237/Cafe_Ceylon_wku3on.png", lat: 5.9782004, lng: 80.348526, instagram: "https://www.instagram.com/cafe_ceylon/?hl=en", googleMaps: "https://maps.app.goo.gl/SHJXxj5BLrDB5q8V7", ownership: "local" },  
  { name: "Petals", rating: "4.6", desc: "A floral-themed cafe offering artisan lattes, fresh pastries and a peaceful garden atmosphere.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287257/Petals_vb8d5g.jpg", lat: 5.9781800860434835, lng: 80.35357067301068, instagram: "", googleMaps: "", ownership: "local" },
  { name: "Veda Cafe", rating: "4.5", desc: "A wellness-inspired cafe serving wholesome bowls, herbal drinks and nourishing plant-based fare.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287237/Veda_Cafe_eb12vq.png", lat: 5.97829759746546, lng: 80.34999516626638, instagram: "", googleMaps: "", ownership: "local" },
  { name: "Cafe Wave", rating: "4.4", desc: "A breezy roadside cafe with fresh juices, light bites and a chilled surf-town vibe.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287235/cafe_wave_nak6fe.jpg", lat: 5.98254317290508, lng: 80.33695907790974, instagram: "", googleMaps: "", ownership: "foreign" },
  { name: "Abrazo", rating: "4.5", desc: "A Spanish-inspired cafe serving tapas-style bites, specialty coffee and warm coastal hospitality.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287235/Abrazo_h3loxm.jpg", lat: 5.96829229558289, lng: 80.37337977301502, instagram: "", googleMaps: "", ownership: "local" },
  { name: "Crave", rating: "4.6", desc: "A popular local cafe known for its flavour-packed brunches, fresh smoothies and vibrant atmosphere.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287235/crave_fjckup.jpg", lat: 5.9726530766658374, lng: 80.3631771134925, instagram: "", googleMaps: "", ownership: "foreign" },
  { name: "Café Samaya", rating: "4.5", desc: "A serene hillside cafe with panoramic ocean views, traditional Sri Lankan flavours and mindful hospitality.", image:"https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287237/Cafe_Samaya_ufdsjh.png", lat: 5.9730175, lng: 80.4349573, instagram: "", googleMaps: "", ownership: "local" },
];
...
const TRANSPORT_VENUES = [
  { name: "AK Bike Rentals", rating: "5.0", desc: "Top-rated scooter rentals and easy local movement around Ahangama.", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1787570539/AK_bike_rental_1_jajy1y.webp", instagram: "", googleMaps: "https://maps.app.goo.gl/4i3vmix5xRGhJYzh9", ownership: "local" },
  { name: "Scooty Rental & Taxi Service", rating: "5.0", desc: "Quick scooter access and local transport support while staying in the area.", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287235/scooty_rentals_and_bike_services_gtzqlc.webp", instagram: "", googleMaps: "https://maps.app.goo.gl/hTVAV4kSbLJSvLeQ9", ownership: "local" },
  { name: "Happy Tours", rating: "5.0", desc: "A practical transport partner for local trips and travel support around the south coast.", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287234/Happy_Tours_bkh98m.jpg", instagram: "https://www.instagram.com/happy_tours_u/?hl=en", googleMaps: "https://maps.app.goo.gl/gVEjdx1WQRgYF52s7", ownership: "foreign" },
  { name: "Nova Rent a Car", rating: "4.9", desc: "Cars and transport options for visitors looking to explore beyond Ahangama.", image: "https://res.cloudinary.com/dp7in4ulw/image/upload/v1787287258/Nova_Rent_a_Car_wuaos2.png", instagram: "", googleMaps: "https://maps.app.goo.gl/ew4MYxtAefLNsLMR8", ownership: "foreign" },
];
