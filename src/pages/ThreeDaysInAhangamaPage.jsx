...
const costRows = [
  ...
  },
  {
    ...
    assumption:
      "Estimated at LKR 18,000, with 30 minutes free valued at LKR 3,000",
    cost: 18000,
    savings: 3000,
  },
  {
        ...
        <div className="dm-wrap">
                    ...
                    >
                      {section.aside.map((item) => (
                        <div key={item} style={{ display: "flex", gap: 10 }}>
                          <HeartOutlined
                            style={{ color: "#8B7B63", marginTop: 4 }}
                          />
              ...
              <Col xs={24} lg={12}>
                <Space direction="vertical" size={12} style={{ width: "100%" }}>
                  <Space align="center" size={10}>
                    <LaptopOutlined
                      style={{ fontSize: 20, color: "#6C7B71" }}
                    />
                  ...
                  <Paragraph
                    style={{ margin: 0, color: "#5C5953", lineHeight: 1.8 }}
                  >
                    The reason this itinerary works is that it never treats work
                    as a failure of the holiday. It just gives work a proper
                    container. Colive is the clean desk-day answer. Daily Dose
                    is the laptop-and-coffee answer. Focus Hub is the backup
                    when you want a more classic coworking-cafe hybrid. That
                    means the rest of the day can genuinely be about your body,
                    your mood, and the pace of the town.
                  </Paragraph>
                </Space>
              </Col>
              <Col xs={24} lg={12}>
          ...
          >
            <Space direction="vertical" size={10} style={{ width: "100%" }}>
              ...
              <Paragraph
                style={{ color: "#5C5953", marginBottom: 0, lineHeight: 1.8 }}
              >
              ...
              <Col xs={24} md={8}>
                <Card
                  style={{
                    ...
                    border: "1px solid rgba(47,62,58,0.08)",
                    background:
                      "linear-gradient(180deg, #f3faf5 0%, #eef7f0 100%)",
                  }}
                  bodyStyle={{ padding: 22 }}
                >
                  <Text
              ...
              <Col xs={24} md={8}>
                <Card
                  style={{
                    ...
                    border: "1px solid rgba(47,62,58,0.08)",
                    background:
                      "linear-gradient(180deg, #fffaf1 0%, #fff4dd 100%)",
                  }}
                  bodyStyle={{ padding: 22 }}
                >
                  <Text
                  ...
                  <Paragraph style={{ marginBottom: 0, color: "#5C5953" }}>
                    ...
                    the extra value of Samba&apos;s free coffee and Spa
                    Station&apos;s free aromatherapy add-on.
                  </Paragraph>
                </Card>
              </Col>
            </Row>
