...
const SECTION_COPY = {
  stay: {
    ...
    subheadline:
      "Small hotels, private villas and rooms with a sense of place.",
  ...
  surf: {
    ...
    subheadline:
      "Reef breaks, quiet coves and the changing moods of the Indian Ocean.",
  ...
  experiences: {
    ...
    subheadline:
      "Lake mornings, village roads and a slower view of the south coast.",
  ...
  shopping: {
    ...
    subheadline:
      "Independent shops, useful objects and the people behind them.",
...
const PAGE_PLAN = [
  ...
  [
    ...
    "IntroductionPage",
    "Welcome to Ahangama",
    "A note from the people who live here",
  ],
  [
    "opening",
    "how-to-use",
    "HowToUsePage",
    "Keep This With You",
    "This guide was designed to travel with you. Here's how to get the most from it.",
  ],
  [
    "opening",
    "area-glance",
    ...
    "Distances here are short. Don't be afraid to explore beyond the part of Ahangama you're staying in.",
  ],
  [
    "opening",
    "essential-map-left",
    "EssentialMapSpreadPage",
    "The Essential Ahangama Map",
    "Koggala to Midigama",
  ],
  [
    "opening",
  ...
  [
    ...
    "ItineraryPage",
    "Your First 24 Hours",
    "Just arrived? Don't overthink it. Here's how we'd spend your first day.",
  ],
  ...
  [
    ...
    "TownStoryPage",
    "A Town in Motion",
    "Surf brought many travellers here. What they found was a place with much more going on beneath the surface.",
  ],
  [
    "opening",
    "ahangama-edit",
    "AhangamaEditPage",
    "20 Places We Love",
    "If you only bookmark one page, make it this one.",
  ],
  [
    "opening",
    "people-left",
    "PeopleSpreadPage",
    "People of Ahangama",
    "Four people helping shape this corner of the south coast.",
  ],
  [
    "opening",
    "people-right",
    "PeopleSpreadPage",
    "People of Ahangama",
    "The Local · The Maker · The Waterman · The New Generation",
  ],
  [
    "opening",
    "opening-partner",
    "OpeningPartnerPage",
    "Ahangama Guide — Opening Partner",
    "A premium commercial space for our lead partner.",
  ],
  [
    "stay",
    "section-opener",
  ...
  [
    ...
    "StayCollectionPage",
    "Hotels We Love",
    "Eight dependable addresses, from coast road classics to inland retreats.",
  ],
  [
    "stay",
    "boutique-hotels",
    "StayCollectionPage",
    "Boutique Hotels",
    "Eight smaller stays with a clear point of view.",
  ],
  [
    "stay",
    "villas-edit",
    "StayCollectionPage",
    "Villas We Love",
    "Eight private places for space, quiet and longer tables.",
  ],
  [
    "stay",
    "stay-finder",
    "StayFinderPage",
    "Find Your Stay",
    "Start with the kind of trip you want to have.",
  ],
  [
    "stay",
    "stay-neighbourhoods",
    ...
    "Five neighbourhoods, five different ways to experience Ahangama.",
  ],
  [
    "stay",
    "stay-story",
    "StayStoryPage",
    "A Room With Rhythm",
    "Inside one particularly interesting stay.",
  ],
  [
    "stay",
    "full-page-ad",
    "FullPageAd",
    "Stay Partner",
    "A premium commercial position for a leading stay partner.",
  ],
  [
    "eat-drink",
    "section-opener",
    "EatDrinkOpenerPage",
    "Eat & Drink",
    "Where to eat, drink and spend a long afternoon.",
  ],
  [
    "eat-drink",
    "breakfast",
    ...
    "Breakfast",
    "Ten starts to the day, from early coffee to a table worth lingering over.",
  ],
  [
    "eat-drink",
    "coffee-cafes",
  ...
  [
    ...
    "EatDrinkRecommendationsPage",
    "Lunch",
    "Ten places that reward an open afternoon.",
  ],
  [
    "eat-drink",
    "sri-lankan-food",
  ...
  [
    ...
    "EatDrinkRecommendationsPage",
    "Sunset Drinks",
    "Eight places to watch the light go and order another.",
  ],
  [
    "eat-drink",
    "after-dark",
  ...
  [
    ...
    "food-culture",
    "FoodCulturePage",
    "The New Ahangama Table",
    "How local ingredients, new ideas and old knowledge are reshaping the way the town eats.",
  ],
  [
    "eat-drink",
    "full-page-ad",
    "FullPageAd",
    "Eat & Drink Partner",
    "A premium commercial position for a leading food and drink partner.",
  ],
  [
    "surf",
    "section-opener",
    "SurfOpenerPage",
    "Beach & Surf",
    "Swim, surf and find your place along the coast.",
  ],
  [
    "surf",
    "beach-comparison",
    "BeachComparisonPage",
    "Which Beach Today?",
    "Compare the coast by swimming, surfing, beginners, families, food, sunset and atmosphere.",
  ],
  [
    "surf",
    "beaches-edit",
    "BeachesWeLovePage",
    "Beaches We Love",
    "Six stretches of coast, each with a different reason to stop.",
  ],
  [
    "surf",
    "surf-guide",
    "SurfAhangamaPage",
    "Surf Ahangama",
    "Breaks, levels, tides, season and the basics of sharing the water well.",
  ],
  [
    "surf",
    "surf-services",
    "SurfServicesPage",
    "Surf Schools, Coaches & Board Hire",
    "Eight useful contacts for learning, improving and finding the right equipment.",
  ],
  [
    "surf",
    "dawn-patrol",
    "DawnPatrolPage",
    "Dawn Patrol",
    "A photography-led study of the coast before the day begins.",
  ],
  [
    "surf",
    "full-page-ad",
    "FullPageAd",
    "Surf Partner",
    "A premium commercial position for a leading surf partner.",
  ],
  [
    "experiences",
    "section-opener",
    ...
    "Experience Ahangama",
    "The best days begin beyond the main road.",
  ],
  [
    "experiences",
    "things-to-do",
    "ThingsToDoPage",
    "10 Things You Should Do in Ahangama",
    "A first list for curious days on the south coast.",
  ],
  [
    "experiences",
    "beyond-beach",
    "BeyondBeachPage",
    "Beyond the Beach",
    "Nature · Culture · Cooking · Lakes · Wildlife",
  ],
  [
    "experiences",
    "half-day-trips",
  ...
  [
    ...
    "Three routes for seeing more without rushing through it.",
  ],
  [
    "experiences",
    "your-way",
    ...
    "Ahangama Your Way",
    "Couples · Kids · Groups · Solo travellers",
  ],
  [
    "experiences",
    "inland-feature",
    ...
    "An editorial journey into inland Ahangama.",
  ],
  [
    "wellness",
    "section-opener",
    "WellnessOpenerPage",
    "Wellness",
    "Movement, treatment and room to reset.",
  ],
  [
    "wellness",
    "movement",
    ...
    "Eight studios and spaces for strength, mobility and mindful practice.",
  ],
  [
    "wellness",
    "treatments",
    "WellnessVenuesPage",
    "Massage, Spa & Ayurveda",
    "Eight places for treatment, restoration and traditional care.",
  ],
  [
    "wellness",
    ...
    "Wellness Experiences",
    "Breathwork · Sound · Meditation · Recovery",
  ],
  [
    "wellness",
    "full-page-ad",
    "FullPageAd",
    "Wellness Partner",
    "A premium commercial position for a leading wellness partner.",
  ],
  [
    "shopping",
    "section-opener",
    "ShopLocalOpenerPage",
    "Shop Local",
    "Independent shops, useful objects and things made with intention.",
  ],
  [
    "shopping",
    "shops-edit",
    "ShopRecommendationsPage",
    "Independent Shops We Love",
    "Ten local addresses for thoughtful finds and everyday essentials.",
  ],
  [
    "shopping",
    "take-home",
    "TakeHomePage",
    "What to Take Home",
    "Fashion · Craft · Food · Gifts · Homeware",
  ],
  [
    "born",
    "section-opener",
    ...
    "Born in Ahangama",
    "Local brands, makers and creatives born on the South Coast.",
  ],
  [
    "born",
    "fashion-accessories",
  ...
  [
    ...
    "BornBrandsPage",
    "Brands We Love",
    "Twelve standout Ahangama-born brand profiles · What they make · Where to find them",
  ],
  [
    "essentials",
    "rainy-day",
    ...
    "Twelve useful ways to enjoy Ahangama when the weather turns.",
  ],
  [
    "essentials",
    "whats-on",
    "WhatsOnPage",
    "What's On",
    "A live rhythm of music, movement, food and gatherings.",
  ],
  [
    "essentials",
    "useful-ahangama",
    "UsefulAhangamaPage",
    "Useful Ahangama",
    "Doctors · Pharmacies · ATMs · Groceries · Laundry · SIMs · Coworking · Emergencies",
  ],
  [
    "essentials",
    "getting-around",
    "GettingAroundPage",
    "Getting Around",
    "Tuk-tuks · Scooters · Taxis · Trains · Airport transfers",
  ],
  [
    "essentials",
    "know-before-you-go",
    "KnowBeforeYouGoPage",
    "Know Before You Go",
    "Money · Weather · Ocean safety · Etiquette · Tipping · Driving · Sustainability",
  ],
  [
    "essentials",
    "directory",
    "AhangamaDirectoryPage",
    "The Ahangama Directory",
    "150 venues · Map numbers · Live updates",
  ],
  [
    "closing",
    "inside-cover",
...
const WELLNESS_VENUES_BY_PAGE = {
  ...
  50: [
    ...
    "the-nuga-house",
    "sellam",
    "krish-combat-fitness",
    "sarana-ahangama",
    "coconut",
  ],
  51: [
    "aksaaya-ayurveda-wellness-spa",
    "sarana-ahangama",
    "senses",
    "coconut",
...
const SHOPPING_VENUES_BY_PAGE = {
  ...
  55: [
    "daydream",
    "gusta",
    "dirty-clothes-midigama",
    "klean-laundry-ahangama",
    "mudra-herbal-spicy-tea-shop",
    "tea-zone-ceylon",
    "pachcha-sanni",
  ],
};
...
function getSectionPlaces(section, pageNumber) {
  const curatedSlugs =
    STAY_VENUES_BY_PAGE[pageNumber] ||
    EAT_DRINK_VENUES_BY_PAGE[pageNumber] ||
    SURF_VENUES_BY_PAGE[pageNumber] ||
    EXPERIENCE_VENUES_BY_PAGE[pageNumber] ||
    WELLNESS_VENUES_BY_PAGE[pageNumber] ||
    SHOPPING_VENUES_BY_PAGE[pageNumber] ||
    BORN_VENUES_BY_PAGE[pageNumber];
  if (curatedSlugs) {
    return curatedSlugs
